...
- Στα 30+ Bitcoin ATM που εμφανίζει ο χάρτης της [Coin ATM Radar](https://coinatmradar.com/country/83/bitcoin-atm-greece/). Τα περισσότερα από αυτά ανήκουν στην [Bcash Greece](https://bcash.eu/gr/) ([δείτε τα βίντεο με οδηγίες χρήσης](https://www.youtube.com/channel/UCo4WSs5gFgp9RgvR2f-1okg/videos)), στην [Bitcoinmat](https://bitcoinmat.sk/) και στην [Bitomat](https://bitomat.com) (γνωστή και ως [Shitcoins Club](https://shitcoins.club)). Και οι τρεις εταιρείες είναι εγγεγραμμένες στο [Μητρώο ανταλλακτηρίων κρυπτονομισμάτων της Ελληνικής Επιτροπής Κεφαλαιαγοράς](http://www.hcmc.gr/aweb/files/laundering/files/Register%20of%20Providers%20of%20Exchange%20Services_EL.pdf).
...
Μπορείτε να δέχεστε πληρωμές χαμηλής αξίας (π.χ. για αγορά ενός καφέ), γρήγορα, και με χαμηλά έξοδα, μέσω του δικτύου Bitcoin Lightning. Σε φυσικό κατάστημα, δοκίμαστε το [Wallet of Satoshi](https://www.walletofsatoshi.com) ή το [Breez](https://breez.technology) ή το [Phoenix](https://phoenix.acinq.co). Σε ηλεκτρονικό κατάστημα δοκιμάστε το [BTCPay server](https://btcpayserver.org). Στην περίπτωση του ηλεκτρονικού καταστήματος θα χρειαστείτε incoming channel capacity.
